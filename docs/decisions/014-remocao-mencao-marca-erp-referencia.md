...
- Documentos analíticos (`docs/strategy/ANALISE_NETSUITE_vs_BUSSOLA_v1.{md,html}`) — renomeados para `ANALISE_NS_vs_BUSSOLA_v1.*`
...
> **Nota sobre esta seção:** Por razão de rastreabilidade factual (exceção §4 da Política abaixo), o nome do ERP de referência é preservado exclusivamente nos caminhos de arquivo históricos desta seção de contexto (ex: `ANALISE_NETSUITE_vs_BUSSOLA_v1.*`). Esta é a única menção nominativa permitida neste ADR.
...
- **Uma menção explicativa permanece neste ADR** — necessária para contexto (ver nota na seção Contexto acima).
...
`docs/decisions/014-remocao-mencao-marca-erp-referencia.md`

## Changelog de adoção

- **2026-04-22** — DRAFT redigido pelo PO Assistant em `.auto-memory/proposals/adr_014_draft.md`, aprovado por Luigi via sessão Cowork.
- **2026-04-22** — Accepted. PR `chore/SSE-trademark-hygiene-netsuite` mergeado. DM executou substituições em 19 arquivos, sweep GitHub (issue #46 atualizada), 3 renames com stubs (remoção agendada 2026-06-22).
