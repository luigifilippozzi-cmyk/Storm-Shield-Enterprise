...
| Amarelo | 1-3 overdue OU >20% em risco OU CI instavel |
| Vermelho | >3 overdue OU bloqueio sem resolucao OU fase >2 semanas atrasada OU CI/deploy quebrado |
...
// <!--METRICS_START-->
const dashboardData = {
  lastUpdated: "2026-04-09T15:30:00",
  updatedBy: "PM Agent",
  health: "Verde",
  healthReason: "Todas as tarefas no prazo",
  activeFase: 1,
  kpis: { totalTarefas: 45, concluidas: 38, percentGeral: 84, backendModules: 12, frontendPages: 8, specFiles: 66, endpoints: 42 },
  fases: [{ nome: "Fase 1 — MVP", total: 20, concluidas: 18, percent: 90, saude: "Verde" }],
  alertas: { bloqueantes: [], overdue: [], emRisco: [], proximos7: [] },
  infra: { ci: { status: "verde", data: "2026-04-09" }, deployApi: { status: "verde", data: "2026-04-09" }, deployWeb: { status: "verde", data: "2026-04-09" }, prsAbertos: [] },
  squad: { ultimaSessaoDM: "", tarefasConcluidas: [], subagentesAcionados: [], branchesAtivas: [] },
  inconsistencias: [],
  recomendacoes: []
};
// <!--METRICS_END-->
