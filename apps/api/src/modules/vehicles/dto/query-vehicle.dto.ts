...
export class QueryVehicleDto {
  ...
  @ApiPropertyOptional({ enum: ['excellent', 'good', 'fair', 'poor'], description: 'Filter by condition' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ enum: ['year', 'make', 'model', 'created_at', 'updated_at', 'mileage'], default: 'created_at' })
  @IsOptional()
  @IsString()
